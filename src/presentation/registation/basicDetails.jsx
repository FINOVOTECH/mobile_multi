...
const BasicDetails = ({
  ...
  const clientTypeOptions = ["PHYSICAL", "DEMAT"];
  ...
  const handleSubmitBasicDetails = async () => {
    ...
    const payload = {
      ...
      PEPStatus: pepStatus,
      clientType,
      firstDPId: clientType === "DEMAT" ? firstDPId : "",
      secondDPId: clientType === "DEMAT" ? secondDPId : "",
    };
    console.log("Basic Details Payload:", payload);
    try {
      const response = await fetch(
        `${baseUrl}/api/v1/first/registration/basic-details`,
        {
          method: "POST",
          headers: {
      ...
      if (response.ok && data.status === "SUCCESS") {
        ...
        const errorMessage =
          data.message || data.error || "Basic details submission failed";
  ...
  const handleSkipNomination = async () => {
    ...
    try {
      ...
      if (response.ok && data.status === "SUCCESS") {
        ...
        Alert.alert("Error", data.message || "Failed to skip nomination");
      }
    } catch (error) {
                  ...
                  <View style={styles.inputContainer}>
                    ...
                    <TextInput
                      ...
                      onChangeText={(text) => {
                        ...
                        setFirstDPId(filtered);
                      }}
                      autoCapitalize="characters" // optional: force uppercase
                      placeholderTextColor="#999"
                    />
                  </View>
          ...
          <View style={styles.modalContainer}>
            ...
            <View style={styles.modalContent}>
              ...
              <Text style={styles.modalSubtitle}>
                Do you want to add a nominee to your account?
              </Text>
