...
const ChangePassword = ({ navigation }) => {
  ...
  const handlePasswordChange = (text, index, passwordType) => {
    ...
    if (text && index < 3) {
      const refs =
        passwordType === "new" ? newPasswordRefs : confirmPasswordRefs;
  ...
  const handleKeyPress = (e, index, passwordType) => {
    if (e.nativeEvent.key === "Backspace" && index > 0) {
      const currentValue =
        passwordType === "new" ? newPassword[index] : confirmPassword[index];
  ...
  const validatePasswords = () => {
    ...
    if (
      newPassword.join("") !== confirmPassword.join("") &&
    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.formContainer}>
          ...
          {errors.match && <Text style={styles.errorText}>{errors.match}</Text>}
          ...
          <View style={styles.infoContainer}>
            ...
            <View style={styles.infoTextContainer}>
              ...
              <Text style={styles.infoText}>
                PIN must not contain your birth year or phone digits.
              </Text>
              <Text style={styles.infoText}>
                PIN must be different from previous PIN
              </Text>
            </View>
          </View>
        </View>
